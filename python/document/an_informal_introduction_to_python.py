...
#   if the string contains a single quote and no double quotes
...
# If you ’t want characters prefaced by \ to be interpreted as special characters
...
# however, out of range slice indexs are handled gracefully when used for slicing
